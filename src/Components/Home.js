        ...
        <>
            <div className={`container my-3 text-${props.mode === 'light' ? "dark" : "light"} `}>
                <div className='container my-3'>
                    <div className="mb-3">
                        <h2>Enter Text</h2>
                        <textarea className="form-control" value={text} onChange={handleOnChange} id="myTextarea" rows="5" style={{ backgroundColor: props.mode === 'light' ? "white" : "#313233", color: props.mode === 'light' ? "Black" : "White" }}></textarea>
                    </div>
                    ...
                    <button type="button" className="btn btn-primary mx-2" onClick={handleExtraSpaces}>ExtraSpaces</button>
                </div>
                <div className="container text-center">
                    <div className="row">
                        <div className="col">
                            <h3>Words & Charachters</h3>
                            <p>This text have {text.split(" ").length} words and {text.length} charachters</p>
                        </div>
                        <div className="col">
                            <h3>Reading Time</h3>
                        ...
                        <div className="col">
                            <h3>Preview</h3>
                            <p>{text.length > 1 ? text : "Enter text to preview here"}</p>
                        </div>
                    </div>
                </div>
            </div>
